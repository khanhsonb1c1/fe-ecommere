<template>
  <div>
    <div class="card">
      <div class="card-body d-flex justify-content-between flex-wrap flex-row" v-for="tracking in trackings" :key="tracking.code">
        <div >
          <h6 class="card-title float-start" style="line-height: inherit">
            {{ tracking.code }}
          </h6>
          <span :class="[tracking.received == true ? 'bg-success' : 'bg-warning','badge ms-2 p-1']">{{
